...
export const Definitions = {
  ...
  session_background: keybind("ctrl+b,ctrl+y,<leader>z", "Background synchronous subagents"),
  ...
  session_shell_view: keybind("<leader>v", "View background commands"),
...
export const CommandMap = {
  ...
  session_shell_view: "session.shell.view",
