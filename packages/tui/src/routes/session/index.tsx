...
// Editor/IDE context (active file + selection) pushed via the SDK
// `ide.context.updated` event. Local to the TUI package — the old `@/ide`
// import doesn't cross the extracted package boundary.
...
export function Session() {
  ...
  const messageContextMap = new Map<string, IdeEditorContext>()
...
function UserMessage(props: {
  ...
  index: number
  pending?: string
  editorContext?: IdeEditorContext
}) {
  const ctx = use()
  const local = useLocal()
