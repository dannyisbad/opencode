...
export const Parameters = Schema.Struct({
  ...
  background: Schema.optional(Schema.Boolean).annotate({
    description:
      "Run the agent in the background and return immediately. Prefer this for long-blocking or independent work, or when the user may want to keep talking to you while it runs. You will be notified when it completes. DO NOT sleep, poll, or proactively check on its progress.",
  }),
})
