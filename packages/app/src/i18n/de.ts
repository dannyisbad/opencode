...
export const dict = {
  ...
  "home.activity.title": "Token-Aktivität",
  "home.activity.daily": "Täglich",
  "home.activity.weekly": "Wöchentlich",
  "home.activity.cumulative": "Kumulativ",
  "home.activity.loading": "Aktivität wird geladen",
  "home.activity.empty": "Noch keine Token-Aktivität",
  "home.activity.lifetimeTokens": "Token gesamt",
  "home.activity.peakTokens": "Token-Spitze",
  "home.activity.longestTask": "Längste Aufgabe",
  "home.activity.currentStreak": "Aktuelle Serie",
  "home.activity.longestStreak": "Längste Serie",
  "home.activity.days.one": "{{count}} Tag",
  "home.activity.days.other": "{{count}} Tage",
  "home.activity.summary":
    "{{tokens}} Token gesamt, {{peak}} Token-Spitze, {{current}} aktuelle Serie, {{longest}} längste Serie.",
