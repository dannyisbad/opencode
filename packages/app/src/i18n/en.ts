export const dict = {
  ...
  "home.title": "Home",
  "home.activity.title": "Token activity",
  "home.activity.daily": "Daily",
  "home.activity.weekly": "Weekly",
  "home.activity.cumulative": "Cumulative",
  "home.activity.loading": "Loading activity",
  "home.activity.empty": "No token activity yet",
  "home.activity.lifetimeTokens": "Lifetime tokens",
  "home.activity.peakTokens": "Peak tokens",
  "home.activity.longestTask": "Longest task",
  "home.activity.currentStreak": "Current streak",
  "home.activity.longestStreak": "Longest streak",
  "home.activity.days.one": "{{count}} day",
  "home.activity.days.other": "{{count}} days",
  "home.activity.summary":
    "{{tokens}} lifetime tokens, {{peak}} peak tokens, {{current}} current streak, {{longest}} longest streak.",
