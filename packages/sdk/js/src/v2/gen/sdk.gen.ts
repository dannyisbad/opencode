...
import type {
  ...
  ExperimentalSessionShellErrors,
  ExperimentalSessionShellResponses,
  ExperimentalShellKillErrors,
  ExperimentalShellKillResponses,
  ExperimentalShellOutputErrors,
  ExperimentalShellOutputResponses,
...
export class Session extends HeyApiClient {
  ...
  /**
   * List background shell commands
   *
   * List the bash tool's background commands for a session with their live status.
   */
...
export class Shell extends HeyApiClient {
  ...
  /**
   * Kill background shell command
   *
   * Stop a running background shell command.
   */
